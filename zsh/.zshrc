...
#ssh auto fill
alias yk='pkill -9 ssh-agent;pkill -9 ssh-pkcs11-helper;ssh-add -e /usr/local/lib/opensc-pkcs11.so;ssh-add -k -s /usr/local/lib/opensc-pkcs11.so; ssh-add -l'
PATH=/Users/michahuy/bin:$PATH
# Yubikey handler
reload-ssh() {
